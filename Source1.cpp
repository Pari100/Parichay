...
void Dot::move()
{
	...
	if ((mPosX < 0) || (mPosX + DOT_WIDTH > LEVEL_WIDTH) || (mPosX + DOT_WIDTH > SCREEN_WIDTH))
	{
		//Move back
		mPosX -= mVelX;
	}
	...
	if ((mPosY < 0) || (mPosY + DOT_HEIGHT > LEVEL_HEIGHT) || (mPosY + DOT_HEIGHT > SCREEN_HEIGHT))
	{
		//Move back
		mPosY -= mVelY;
	}
...
bool loadMedia()
{
	...
	//Load dot texture
	if (!gDotTexture.loadFromFile("x64/H1.png"))
	{
	...
	if (!gBGTexture.loadFromFile("x64/bg.png"))
	{
